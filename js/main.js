...
var timerID = -1;
var pIEVersion = "";     //plugins version
...
var isZoomWork = 0;
var isFocusWork = 0;
var needMoreTimeIPC = ["5006","5007","5010","5034","5035","5036","5038","5039","5065","5066","5067","5094","5095","5096"];
var isNVRV200IPC = ["3024","3057","3058","3500","6023","6024","6029","6030"];
var stall;
$(function(){
	try {
		var versionType = getBrandType();//版端返回品牌还是中性的类型
		if(versionType == 100){
		pIEVersion = "3.3.0.31";
		}else{
		pIEVersion = "3.3.0.31";
...
function RegLeftEvent(){
	...
	$("#BsHmode").change(function () {	    if ($("#BsHmode").val() == 0) {
