...
function lan(pageName){
	...
	sH("BsHwdCtSt", "IDS_LEFT_LED"); sH("BsHwdSchedule", "IDS_BS_TIMING"); sH("BsHwdManual", "IDS_BS_MANUAL"); sH("BsHwdAuto", "IDS_BS_AUTO"); sH("leftpat", "IDS_LEFT_PAT"); sH("lefttim", "IDS_LEFT_TIM");
		...
		sH("alarm_humidity", "IDS_ALARM_HUMIDITY");sH("alarm_person", "IDS_HUMAN_DETECTION");
        ...
        //C,E平台去除隐藏遮住
        if (gVar_first.model > 1000 && gVar_first.model < 2000 || gVar_first.model > 3000 && gVar_first.model < 4000||isModel_6000To7000()) {
            $("#av_mask").remove();
        }
	...
	//此处作判断，是否加载有些左边菜单或者控件
        ...
        //PrivacyZone
        if (gVar_first.hasPrivacyZone == -1 || (gVar_first.model > 3000 && gVar_first.model < 4000)) {
            $("#av_mask").remove();
        }
		...
		/*非 E平台 或不支持Onvif 隐藏onvif页面,否则不隐藏onvif页面*/
		if(gVar_first.onvifFlag==0||! (gVar_first.model>3000&&gVar_first.model<4000||isModel_6000To7000()) )
		{
		...
		*/
		...
		for(var i=0;i<count;i++)
         ...
         if(gVar_first.model>1000&&gVar_first.model<2000||gVar_first.model>3000&&gVar_first.model<4000||gVar_first.model>5000&&gVar_first.model<7000)
         {
            ...
            //if((gVar_first.reserve2 >> 5 & 0x01) == 1)
            {
                $("#liveNAA").show();
            }
         }
	...
	if(browserVer.browsers=="Edge")
	...
	}else if(pageName == "alarm_person"){
        sV("alarmpersonRf", "IDS_RE_REFRESH"); sV("AlarmpersonSave", "IDS_CRUISE_SAVE"); sH("AmTrger_Man", "IDS_ALARM_TRGER"); sH("AmTactics", "IDS_ALARM_TACTICS"); sH("AmMoSX", "IDS_ALARM_MVMOSX"); sH("rcAlarmNotice_Man", "IDS_RCPLAN_TIP4");
        sH("humanAlarmRing","IDS_ALARM_RING");sH("AlarmT_Man","IDS_HUMANDETECTION_ALARM");
        $("#AmSedEmail_Man").prepend(lg.get("IDS_ALARM_SEDEMAIL"));
        $("#AmCaptImg_Man").prepend(lg.get("IDS_ALARM_CAPTIMG"));
        $("#AmRecord_Man").prepend(lg.get("IDS_ALARM_RECORD"));
        $("#AmIOOutput").prepend(lg.get("IDS_ALARM_IOOUTPUT"));
        ...
        sH("AmHumidityT", "IDS_ALARM_HUMIDITY_CONFORTABLE_RANGE");
        sH("AmHumidityTips", "IDS_ALARM_HUMIDITY_RANGE_TIPS");
        sH("AmSensitivity","IDS_ALARM_SENSIT");sH("AmLowSensit","IDS_ALARM_LOWSENSIT");sH("AmMidSensit","IDS_ALARM_MIDSENSIT");sH("AmHighSensit","IDS_ALARM_HIGHSENSIT");sH("AmZC","IDS_ALARM_ZC");sH("AmCapttime_Man","IDS_ALARM_TIME");
        sH("AmLowerSensit","IDS_ALARM_LOWER_SENSIT");sH("AmLowestSensit","IDS_ALARM_LOWEST_SENSIT");
        sH("Am_OutMove","IDS_ALARM_MOVEOUT");
        sH("AlarmPCSound_Huamn","IDS_RC_SOUNDALARM_AS_PC");
        sH("rcTempTips_H", "IDS_ALARM_TTEMPERATRUETIPS_HUM");
        sH("AmVCBitmap_Man", "IDS_ALARM_VCBITMAP");
        //document.getElementById("rcTempTips_H").innerHTML = lg.get("IDS_ALARM_TTHUM1") + "% ," + lg.get("IDS_ALARM_TTHUM2") + "% ," + lg.get("IDS_ALARM_TTHUM3") + "% .";
        sH("AmToPhone_Man","IDS_ALARM_TOPHONE");
        //sH("divAlarmSnapTips", "IDS_ALARM_SNAP_TIPS");sH("divAlarmRecordTips", "IDS_ALARM_RECORD_TIPS");
        document.getElementById("divAlarmSnapTips_Man").innerHTML = lg.get("IDS_ALARM_SNAP_TIPS") + "(" + lg.get("IDS_AV_PARAM") + " -> " + lg.get("IDS_BTN_CAP") + ")";
        document.getElementById("divAlarmRecordTips_Man").innerHTML = lg.get("IDS_ALARM_RECORD_TIPS") + "(" + lg.get("IDS_RECORD_PARAM") + " -> " + lg.get("IDS_RC_VPRATH") + ")";
        sH("AmMotionAlarm", "IDS_DEV_MOTIONDETECTALARM"); sH("AmHumanAlarm", "IDS_DEV_HUMANDETECTION");
        sH("AmMotionTrue", "IDS_OTHER_ON"); sH("AmMotionFalse", "IDS_OTHER_OFF");
        sH("AmHumanTrue", "IDS_OTHER_ON"); sH("AmHumanFalse", "IDS_OTHER_OFF");
        sH("PirMotionAlarm", "IDS_DEV_MOTIONDETECTALARM");

        sH("AlarmIsEb_Man","IDS_ALARM_ISHUMAN");
        sH("AmTactics_Action","IDS_ALARM_TACTICS");
