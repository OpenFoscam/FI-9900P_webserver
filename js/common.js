...
function  detectCapsLock1(e){
    ...
    var isFF = /firefox/i.test(browserName);
    ...
    if(isFF || isChrome || belowIE10){
        if (valueCapsLock >=65 && valueCapsLock  <=90){
            $('#CapsLockTips1').css("visibility","visible");
            $('#trigger1').css("visibility","visible");
        }else{
            $('#CapsLockTips1').css("visibility","hidden");
            $('#trigger1').css("visibility","hidden");
        }
    }
}
function  detectCapsLock2(e){
    ...
    if(isFF || isChrome || belowIE10){
        if (valueCapsLock >=65 && valueCapsLock  <=90){
            $('#CapsLockTips2').css("visibility","visible");
            $('#trigger2').css("visibility","visible");
        }else{
            $('#CapsLockTips2').css("visibility","hidden");
            $('#trigger2').css("visibility","hidden");
        }
    }
}
function  detectCapsLock3(e){
    ...
    if(isFF || isChrome || belowIE10){
        if (valueCapsLock >=65 && valueCapsLock  <=90){
            $('#CapsLockTips3').css("visibility","visible");
            $('#trigger3').css("visibility","visible");
        }else{
            $('#CapsLockTips3').css("visibility","hidden");
            $('#trigger3').css("visibility","hidden");
        }
    }
}
$(document).click(function(e){
    ...
    {
        $('.CapsLockTip').css("visibility","hidden");
        $('.triggerTop').css("visibility","hidden");
    }
})